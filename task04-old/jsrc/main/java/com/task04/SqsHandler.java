...
import net.sf.aws.syndicate.deployment.annotations.lambda.LambdaHandler;
import net.sf.aws.syndicate.deployment.annotations.events.SqsTrigger;
import net.sf.aws.syndicate.deployment.model.RetentionSetting;
